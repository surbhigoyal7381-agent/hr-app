...
This design theme guide creates a **modern, approachable, enterprise-grade** interface for the Grace Group HRMS application. The design philosophy centers on:
...
**Target Audience:** 200 employees ranging from delivery personnel to management at Grace Group Logistics/FMCG company.
...
```
┌─────────────────────────────────────────────────────────┐
│ Header: "Grace Group HRMS" [Account Settings]          │
├─────────────────────────────────────────────────────────┤
│                                                         │
│ ┌─────────────────────┐  ┌─────────────────────┐      │
...
As a **multi-tenant SaaS platform**, Kinexus HRMS must support white-labeling to allow enterprise customers (like Grace Group, and future customers) to customize the application with their own branding. This section defines which elements are customizable and which must remain consistent for system integrity.
...
| **Company Name** | ✓ YES | Max 40 characters | Replaces "Grace Group HRMS" in header |
| **Favicon** | ✓ YES | 32x32px ICO or PNG | Browser tab icon |
| **Product Name** | ✓ YES (Limited) | Max 50 characters | e.g., "Grace Talent Management System" |
...
|---|---|---|---|
| **App Title** | ✓ YES | "Grace Group HRMS" | 50 chars |
...
│ │                                                 │ │
│ │ Company Name: [Grace Group       ]              │ │
│ │                                                 │ │
│ │ App Title: [Grace Group HRMS     ]              │ │
│ └─────────────────────────────────────────────────┘ │
│                                                     │
│ ┌─────────────────────────────────────────────────┐ │
│ │ Color Customization                             │ │
...
#### Example 1: Grace Group (Current Customer)
...
├─ Logo: Grace Group logo
├─ Company Name: "Grace Group HRMS"
...
| API white-label | ✗ | ✓ | Remove Kinexus branding from API |
...
✓ Testing with first customer (Grace Group)
```
...
✓ API white-labeling (remove Kinexus attribution)
...
#### For Kinexus (Platform Developers)
...
| Colors not applying | Verify hex format (#XXXXXX), test in different browser | Kinexus Support |
| Text contrast failing | System auto-warns; choose different shade | Customer |
| Font not loading | Check WOFF2 format, verify CDN access | Kinexus DevOps |
| Mobile responsiveness broken | Logo may be too wide; resize or use icon instead | Kinexus Design |
...
1. **Trademark & Branding Rights**
   ...
   - Kinexus retains rights to underlying platform
   - Customer cannot remove Kinexus copyright notice (in small footer)

2. **Liability**
   - Kinexus not liable for customer branding choices
   - Customer responsible for ensuring brand color accessibility
   - Kinexus may restrict "offensive" branding (case-by-case)

3. **Support Scope**
   - Kinexus supports technical white-labeling setup
   - Kinexus does NOT provide design/branding advice
...
This white-labeling framework enables Kinexus HRMS to serve multiple enterprise customers while maintaining design consistency and platform stability. By carefully balancing customization with control, we create a system that feels personal to each customer while remaining maintainable and accessible.

This design theme transforms the Grace Group HRMS into a **modern, professional, human-centric enterprise application**. The purple-and-teal color scheme conveys trust and professionalism, while warm cream backgrounds and generous whitespace make the interface approachable and easy to use.
