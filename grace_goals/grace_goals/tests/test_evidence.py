...
def _make_cascade_and_goal(suffix="EvidTest"):
    ...
    emp_name = f"Evid {suffix} Employee"
...
class TestEvidence(FrappeTestCase):
    ...
    def test_evidence_pending_on_manual_entry(self):
        from grace_goals.controllers.evidence import validate_evidence
    ...
    def test_duplicate_detection(self):
        from grace_goals.validators.duplicate_detector import _similarity_score
