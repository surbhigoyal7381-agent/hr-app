...
You are extending the Frappe HR implementation for "Grace Group" (FMCG distribution).
...
Utilize Frappe HR's standard Employee Onboarding and Project/Task modules to create structured onboarding pipelines for different roles within Grace Group.
...
Configure standard Leave mechanisms and build a custom hook to ensure operational continuity for fleet management when field workers take leave. For Grace Group, leave structures are heavily dependent on industry standards for FMCG and Q-Comm logistics.
