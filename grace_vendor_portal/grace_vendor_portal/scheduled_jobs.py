...
def calculate_driver_ratings():
    ...
    from grace_vendor_portal.controllers.rating import _recalculate_driver_rating
...
def check_compliance_alerts():
    ...
    try:
        from grace_vendor_portal.controllers.vehicle_compliance import check_all_compliance_alerts
...
def generate_monthly_scorecards():
    ...
    try:
        from grace_vendor_portal.controllers.scorecard import generate_monthly_scorecards as _gen
        _gen()
    except Exception:
